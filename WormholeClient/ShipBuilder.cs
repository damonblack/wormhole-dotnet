...
namespace WormholeClient
{
	...
	public class ShipBuilder : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this._bnOK.Location = new System.Drawing.Point(360, 328);
			...
			this._bnCancel.Location = new System.Drawing.Point(360, 280);
			...
			this._rbGroupBox.Size = new System.Drawing.Size(496, 96);
			...
			this.label5.Text = "Support:  M15 O10 E40";
			// 
			// label4
			// 
			...
			this.label4.Text = "Support:  M30 O40 E25";
			// 
			// label3
			// 
			...
			this.label1.Text = "Power/Range   3/1 *7/0";
			// 
			// radioButton3
			// 
			...
			this.label6.Text = "Support:  M30 O20 E20";
			// 
			// label7
			// 
			...
			// _lblExcessResources
			// 
			this._lblExcessResources.Location = new System.Drawing.Point(240, 320);
			...
			// _lblUsedResources
			// 
			this._lblUsedResources.Location = new System.Drawing.Point(240, 272);
